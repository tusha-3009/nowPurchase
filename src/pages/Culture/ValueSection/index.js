        ...
        <Container>
          ...
          <div className="trWrap aosAnim d-flex justify-content-between ltr">
            <div className="trBox">
              ...
              <h5>Integrity</h5>
              <p>
                We have an unwavering adherence to moral and ethical principles
              </p>
            </div>
            <div className="trBox">
              <div className="trBoxImg">
              ...
              <h5>Empathy</h5>
              <p>
                We experience one another's point of view, rather than just our
                own
              </p>
            </div>
            <div className="trBox">
              ...
              <h5>Ownership</h5>
              <p>
                We possess the freedom to take decisions with the willingness to
                accept the outcome of our actions.
              </p>
            </div>
            <div className="trBox">
              <div className="trBoxImg">
