              ...
              <div class="row">
                <div class="col-lg-12 aosAnim">
                  <div class="sechead keyHead">
                    <h3>
                      <span>Elevating</span> your Metal Manufacturing<br />
                      with technology
                    </h3>
                  </div>
                  ...
                  <div class="keyWrap">
                    <div class="eachkey">
                      <h4><span class="counter">93</span>% Accurate</h4>
                      <h6>Addition/Dilution Suggestion</h6>
                    </div>
                    <div class="eachkey">
                      <h4><span class="counter">25</span>% Reduction</h4>
                      <h6>in Metallurgical Rejection</h6>
                    </div>
                    <div class="eachkey">
                      <h4><span class="counter">10</span>% Reduced</h4>
                      <h6>Production Time</h6>
                    </div>
                    <div class="eachkey">
                      <h4><span class="counter">6</span>% Minimised</h4>
